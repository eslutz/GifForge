...
public sealed class LumaVideoProvider : HttpVideoGenerationProvider
{
  public LumaVideoProvider(HttpVideoGenerationProviderOptions options, HttpClient httpClient)
