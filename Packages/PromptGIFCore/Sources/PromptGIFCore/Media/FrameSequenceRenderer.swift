...
public struct FrameSequenceRenderer {
  ...
  private func makeImage(frameSpec: FrameSpec, width: Int, height: Int) throws -> CGImage {
    guard
      ...
      throw PromptGIFError.mediaRenderingFailed(message: "Could not create frame drawing context.")
    }
    ...
    guard let image = context.makeImage() else {
      throw PromptGIFError.mediaRenderingFailed(message: "Could not create generated frame.")
    }
