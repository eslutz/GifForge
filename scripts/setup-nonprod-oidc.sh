...
repo="eslutz/Gifster"
environment="nonprod"
resource_group="rg-gifster-nonprod"
app_name="Gifster-GitHub-Actions"
apply="false"
...
usage() {
  cat <<'USAGE'
Usage: scripts/setup-nonprod-oidc.sh [--apply] [options]

Configures the GitHub Actions Azure OIDC identity for Gifster nonprod.
...
Options:
  ...
  --environment NAME              GitHub environment. Default: nonprod.
  --resource-group NAME           Azure resource group scope. Default: rg-gifster-nonprod.
  --app-name NAME                 Azure app registration display name. Default: Gifster-GitHub-Actions.
...
The script intentionally grants roles only at the resource-group scope:
  Contributor
...
printf 'Gifster nonprod OIDC setup\n'
