...
public struct FrameSequenceRenderer: Sendable {
  ...
  private func makeImage(frameSpec: FrameSpec, width: Int, height: Int) throws -> CGImage {
    guard
      ...
      throw GifForgeError.mediaRenderingFailed(message: "Could not create frame drawing context.")
    }
    ...
    guard let image = context.makeImage() else {
      throw GifForgeError.mediaRenderingFailed(message: "Could not create generated frame.")
    }
