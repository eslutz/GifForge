...
**Goal:** Build Gifster into an App Store-ready iOS 26.5+ iMessage GIF generation app.
...
**Files:**
- Modify: `project.yml`
- Modify: `Packages/GifsterCore/Package.swift`

- [ ] Install Xcode 26.5 or later.
- [ ] Run `xcodegen generate`.
- [ ] Run `xcodebuild -project Gifster.xcodeproj -scheme Gifster -destination 'generic/platform=iOS Simulator' build`.
...
**Files:**
- Modify: `Packages/GifsterCore/Sources/GifsterCore/Planning/FoundationModelsPromptPlanner.swift`
- Add tests under: `Packages/GifsterCore/Tests/GifsterCoreTests`
...
**Files:**
- Modify: `Extensions/GifsterMessages/MessagesComposerModel.swift`
- Add: `Packages/GifsterCore/Sources/GifsterCore/Storage/ActiveJobStore.swift`
...
**Files:**
- Add: `Packages/GifsterCore/Sources/GifsterCore/Media/MP4FrameExtractor.swift`
- Modify: `Extensions/GifsterMessages/MessagesComposerModel.swift`
...
- Modify: `App/Gifster/AppShellView.swift`
...
**Files:**
- Modify: `project.yml`
- Modify: `App/Gifster/Info.plist`
- Modify: `Extensions/GifsterMessages/Info.plist`
